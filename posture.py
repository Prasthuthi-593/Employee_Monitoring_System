...
try:
    ...
    # current_time = datetime.now().strftime("%H:%M")
    # send_email_alert("Logoff Notification", f"Employee has logged off at {current_time}.")
    # current_time = datetime.now().strftime("%Y-%m-%d %H:%M:%S")
    # employee_name = "Employee"  # Replace with actual employee name if available
    # send_email_alert("Logoff Notification", f"{employee_name} has logged off at {current_time}.")
